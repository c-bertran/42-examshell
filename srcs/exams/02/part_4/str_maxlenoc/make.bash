...
./maxlenoc2 > real
./maxlenoc2 one two three >> real
./maxlenoc2 "   " "        " "    " "                  " "        " >> real
./maxlenoc2 bosdsdfnjodur atehhellosd afkuonjosurafg headfgllosf fghellosag afdfbosnjourafg >> real
./maxlenoc2 "je suis " "suis content   d'être" "ici et pas" " ailleurs" >> real
